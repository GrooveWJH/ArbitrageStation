...
def get_spot_basis_auto_decision_preview(
    ...
    from ._part7 import _apply_switch_confirm_rounds, _match_current_switch_row
    from ._part9 import _get_or_create_auto_cfg
    from ._part15 import _active_spot_hedge_holds, _scan_spot_basis_opportunities
